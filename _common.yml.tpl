...
services:
  ...
  #    HDX_SOLR_PORT: '${HDX_SOLR_PORT}'
      ...
      # MAILCHIMP #
      HDX_MAILCHIMP_API_KEY: ${HDX_MAILCHIMP_API_KEY}
      HDX_MAILCHIMP_LIST_NEWSLETTER: ${HDX_MAILCHIMP_LIST_NEWSLETTER}
      HDX_MAILCHIMP_LIST_NEW_USER: ${HDX_MAILCHIMP_LIST_NEW_USER}
